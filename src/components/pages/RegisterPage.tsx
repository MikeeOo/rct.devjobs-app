            ...
            <div className="card w-full max-w-[90%] bg-primary shadow-xl">
                <div className="card-body">
                    ...
                    <div className="card bg-primary py-2">
                        <div className="form-control py-2">
                            ...
                            <div className="relative text-neutral-content focus-within:text-accent-content">
                                <input
                                    type="email"
                                    className="input w-full rounded-none border-b-accent-content border-l-primary border-r-primary border-t-primary bg-primary pl-10 shadow-accent-content focus:outline-none"
                                />
                    ...
                    <div className="card-actions justify-end">
                        <button className="btn bg-base-100 hover:bg-base-200 hover:text-accent-content">
                            Sign up
                        </button>
                    </div>
                </div>
